...
export default function FAQSection() {
  ...
  return (
    <section className="overflow-hidden pb-10 py-6">
      <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <p className="text-lg text-gray-800 mb-12">
            Find answers to the most common questions about Apply Mate and how
            it works.
          </p>
                  ...
                  >
                    ...
                    <ChevronDown
                      className={cn(
                        ...
                        isOpen
                          ? "rotate-180 text-blue-500 dark:text-green-400"
                          : ""
                      )}
                    />
                  </button>
