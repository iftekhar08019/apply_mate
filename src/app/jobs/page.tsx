...
import Loading from '../dashboard/(user)/my-applications/loading';
import { TooltipProvider } from '@/components/ui/tooltip';
import { Briefcase, Building2, CalendarDays, ExternalLink, Grid3x3, List, MapPin, Search } from 'lucide-react';
...
export default function AllJobs() {
  ...
  return (
    <>
      <TooltipProvider>
         <div  className="relative flex flex-col justify-center items-center text-center py-24 md:py-32 bg-cover bg-center"
        style={{ backgroundImage: "url('/bannerapplication.jpg')" }}>
          <div className="inline-flex items-center gap-2 bg-primary/10 border border-primary/20 px-4 py-2 rounded-full text-white">
            ...
            <span className="text-sm font-medium text-white">My Job Applications</span>
          </div>
          <h1 className="text-4xl font-bold mt-3 text-white">Track Your Job Journey</h1>
